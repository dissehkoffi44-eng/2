...
if uploaded_files:
    ...
    for f in reversed(uploaded_files):
        ...
        with st.container():
            ...
            st.markdown(f"""
                <div class="report-card" style="background:{analysis_data['color_bandeau']}; text-align: center;">
                    <p style="letter-spacing:5px; opacity:0.8; font-size:0.7em; margin-bottom:0px;">
                        SNIPER ENGINE v5.0 | {analysis_data['avis_expert']}
                    </p>
                    <h1 style="font-size:5em; margin: 0; font-weight:900; line-height:1;">
                    <p style="font-size:2em; font-weight:bold; margin: 0; opacity:0.9;">
